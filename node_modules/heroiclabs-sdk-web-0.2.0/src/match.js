...
/**
 * Gets the matchmaking queue status.
 */
export class MatchQueueStatusRequest extends ApiRequest {

  /**
   * @param  {Session} session Session identifying the account making this request.
   * @return {MatchQueueStatusRequest} An instance of this object.
   */
  constructor(session) {
    super('GET', '/v0/match/queue', session);
  }
}

/**
 * Dequeues the current gamer from matchmaking queue
 */
export class MatchDequeueRequest extends ApiRequest {

  /**
   * @param  {Session} session Session identifying the account making this request.
   * @return {MatchDequeueRequest} An instance of this object.
   */
  constructor(session) {
    super('DELETE', '/v0/match/queue', session);
  }
}
